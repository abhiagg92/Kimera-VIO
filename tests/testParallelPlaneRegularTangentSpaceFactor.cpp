...
TEST(testParallelPlaneRegularTangentSPaceFactor, Jacobians) {
  ...
  Matrix H1Expected =
      numericalDerivative21<Vector, OrientedPlane3, OrientedPlane3>(
          boost::bind<Vector>(boost::mem_fn(&ParallelPlaneRegularTangentSpaceFactor::evaluateError),
                              boost::ref(factor), boost::placeholders::_1, boost::placeholders::_2,
                              ParallelPlaneRegularTangentSpaceFactor::OptionalMatrixTypeT<Matrix&>(), gtsam::OptionalMatrixTypeT<Matrix&>()),
          plane_1, plane_2, der_tol);

  Matrix H2Expected =
      numericalDerivative22<Vector, OrientedPlane3, OrientedPlane3>(
          boost::bind<Vector>(&ParallelPlaneRegularTangentSpaceFactor::evaluateError,
                              boost::ref(factor), boost::placeholders::_1, boost::placeholders::_2),
          plane_1, plane_2, der_tol);
